...
fun SettingsScreen(nav: NavController) {
    ...
    Column(
        ...
        Column(
            ...
            // Storage Usage → full page (placeholder)
            SettingsCard(
                icon = IconStorage,
                title = "Storage Usage",
            ...
            // Terms of Use → full page (new, before Privacy)
            SettingsCard(
                icon = IconDocument,
                iconTint = Brand,
                title = "Terms of Use",
            ...
            // Privacy & Security → full page with Privacy Policy
            SettingsCard(
                icon = IconShield,
...
fun StorageUsageScreen(nav: NavController) {
    ...
    Column(
        ...
        Column(
            ...
            // Placeholder – you'll replace this with actual storage data later
            Text(
                "Device storage information will appear here.",
                color = White60,
                fontSize = d.textMd
            )
            Text(
                "Total space, used space, available space, and per‑app usage will be displayed.",
                color = White40,
                fontSize = d.textSm
            )
            // You can later add charts, progress bars, etc.
        }
    }
}
...
fun PrivacyPolicyScreen(nav: NavController) {
    ...
    Column(
        ...
        Column(
            ...
            // Full Privacy Policy text (as provided)
            Text(
                "PRIVACY POLICY\n\n" +
                ...
                "5.1 Use of Cookies and Local Storage\n\n" +
                ...
                "15. EUROPEAN ECONOMIC AREA, UNITED KINGDOM, AND SWITZERLAND RIGHTS (GDPR)\n\n" +
                ...
                "16. NIGERIAN DATA PROTECTION REGULATION (NDPR)\n\n" +
                "16.1 Applicability\n\n" +
...
fun TermsScreen(nav: NavController) {
    ...
    Column(
        ...
        Column(
            ...
            // Full Terms of Service text (as provided)
            Text(
                "TERMS OF SERVICE\n\n" +
                "Last Updated: July 20, 2026\n" +
                "Effective Date: July 20, 2026\n\n" +
                "1. AGREEMENT TO TERMS\n\n" +
                "1.1 Welcome to Reelz\n\n" +
...
// ── (Optional) keep ReelzDialog if used elsewhere ──────────────────────────
